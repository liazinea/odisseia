...
const Editoras = () => {
  ...
  const buscaEditora = async () => {
    ...
    setEditorasBuscadas(response.data.editoras.data);
  };
      ...
      <div className={styles.divPesquisa}>
        <div className={styles.pesquisa}>
          <input
            ...
            placeholder="Pesquise a editora que deseja"
          />
              ...
              {table.getRowModel().rows.map((row) => (
                <div className={styles["linha"]} key={row.original.id}>
                  <ListaEditoras
                    ...
                    buscaEditoras={buscaEditoras}
                    setEditoras={setEditoras}
          ...
          <div className={styles["input"]}>
            ...
            />
            {
              <p className={styles["erro"]}>
                {errors.edi_nome && errors.edi_nome.message}
              </p>
            }
          </div>
