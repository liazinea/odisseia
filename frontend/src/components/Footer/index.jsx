                ...
                <div className="container-contact">
                    ...
                    <ul className='lista-de-contatos'>
                        <li className='contato-item'>
                            <div className='contato-container'>
                                <figure className='contato-bg'>
                                    <img src={Location} alt="ícone de contato" />
                                </figure>
                                <p className="contato-text">
                                    R. Benedicto Moreira de Barros, 120 - Eng. Neiva, Guaratinguetá
                                </p>
                            </div>
                        </li>
                        ...
                        <li className='contato-item'>
                            <div className='contato-container'>
                                <figure className='contato-bg'>
                                    <img src={Phone} alt="ícone de contato" />
                                </figure>
                                <p className="contato-text">
                                    (12) 234567
                                </p>
                        ...
                        <li className='contato-item'>
                            <div className='contato-container'>
                                <figure className='contato-bg'>
                                    <img src={Cellphone} alt="ícone de contato" />
                                </figure>
                                <p className="contato-text">
                                    81200 9188
                                </p>
