...
const Logo = () => {
  return (
    <div className={styles[`footer-logo`]}>
      <div className={styles[`footer-logo-top`]}>
        <svg
        ...
        <span className={styles[`logo-name`]}>Odisseia</span>
      </div>

      <div className={styles[`footer-logo-bottom`]}>
        <span className={styles[`logo-text`]}>E.E Ernesto Quissak</span>
      </div>
    </div>
  );
};
